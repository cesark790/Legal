...
<table cellpadding="1" cellspacing="1" align="center" width="80%" border="0">
	<tr align="center">
		...
		<td id="opcion2" class="seleccionado" width="20%">
...
$(document).ready(function(){
	$('#datos').load("externo.tabla_demandas_cerradas.php",function(data){
		$('#datos').html(data);
	})
})
...
function gasto(demanda){
	$('body').append("<div align='center' id='tabla_gastos'></div>");
	$.ajax({
