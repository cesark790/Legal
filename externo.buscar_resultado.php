...
<table cellspacing="0" align="center" width="100%">
	...
	<tr height="50px">
		...
		<td width="10%"><input size="30" id="resolucion"  style="text-align:center;" type="text" value="<? echo $reg['resolucion'];?>"></td> 
		<td width="5%"></td>
	</tr>
		...
		<td width="10%">
			<input size="30" id="pago" type="text" style="text-align:center;"  value="<? echo $reg['pago'];?>">
		</td>
		<td colspan="2" width="15%"> <div align="center" id="guardar" class="boton">Guardar</div> </td> 
		<td width="5%"></td>
	</tr>
	</tr>
