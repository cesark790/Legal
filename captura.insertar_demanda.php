...
$sql1=mysql_query("INSERT INTO legal_principal(id_gerente,actor,demandado, id_estado, id_entidad, id_ultima_observacion,capturo,expediente,junta,no_nomina,id_ultimo_gasto) VALUES ('$gerente','$actor','$demandado','$estado','$entidad','$ultima_oberservacion','$user','$expediente','$junta','$no_nomina','1') ");
...
<div><strong>Empresa:'$demandado' </strong></div>
